...
public static class SidebarNavItem
{
	public class Get
	{
		...
		public static Expression<Func<Admin.Models.SidebarNavItem, Get>> Expression { get; } = model => new Get
																									    {
																										    Id = model.Id,
																										    Name = model.Name,
																										    Order = model.Order,
	...
	public class Post
	{
		...
		public static Expression<Func<Post, Admin.Models.SidebarNavItem>> Expression { get; } = dto => new Admin.Models.SidebarNavItem
																									   {
																										   Name = dto.Name,
																										   Order = dto.Order,
																										   Active = dto.Active,
